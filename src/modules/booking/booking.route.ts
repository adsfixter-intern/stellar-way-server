...
// --- Public Routes ---
router.get('/check-availability', BookingControllers.checkAvailability);
router.post('/confirm-payment/:transactionId', BookingControllers.confirmPayment);
router.get('/confirm-payment/:transactionId', BookingControllers.confirmPayment);
...
// --- Common/Admin Routes ---
router.get('/', isAuthenticated, authorizeRoles('admin'), BookingControllers.getAllBookings);
router.get('/:id', isAuthenticated, authorizeRoles('user', 'admin'), BookingControllers.getSingleBooking);
router.patch('/:id', isAuthenticated, authorizeRoles('user', 'admin'), BookingControllers.updateBooking);
router.delete('/:id', isAuthenticated, authorizeRoles('user', 'admin'), BookingControllers.deleteBooking);
